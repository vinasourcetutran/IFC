...
public class Download : IHttpHandler {
    ...
    {
        string premiumID = context.Request.QueryString["premiumID"];
        int preID = 0;
        if (int.TryParse(premiumID, out preID))
        {
            Node premiumNode = new Node(preID);
            HttpResponse r = context.Response;
            string file = premiumNode.Properties["Document"].Value;
